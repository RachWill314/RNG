...
class MQTT:
    ...
    sub_topics = [("620155671_pub", 0), ("620155671", 0), ("620155671_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620155671", self.gdp)
        self.client.message_callback_add("620155671_pub", self.toggle)
